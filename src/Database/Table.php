...
abstract class Table extends Base
{
	 ...
	 */
	public function reset_db_version()
	{
		// Reset the DB version
		$this->is_global()
			? update_network_option(get_main_network_id(), $this->db_version_key, '0.0.0')
			:         update_option($this->db_version_key, '0.0.0');

		// Set the DB version
		$this->db_version = '0.0.0';
	}
